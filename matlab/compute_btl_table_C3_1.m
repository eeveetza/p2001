...
for pp = 1:2 % once with and once without PDR
    ...
    for i = 1:length(stano)
        ...
        for it = 1:length(t)
            ...
            result{pp}{count}.deltaf = p2001.Lb - pl(it);
            count = count + 1;
        end
...
tout = [99 90 50 30 10 3 1 0.3 0.1 0.03 0.01 0.003 0.001];
...
legend('P.2001-4', lstr1, 'PDR P.2001-4', lstr2)
xlabel('PE (dB)')
ylabel('n.u.')
grid on
...
legend('PDR P.2001-4', 'P.2001-4','measurements', 'Location','southeast')
grid on
