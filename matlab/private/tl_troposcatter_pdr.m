...
%     v6    09SEP24     Ivica Stevanovic, OFCOM         Introduced the revision from PDR P.617 (see WP 3M Chair's Report 2024, 3M/106 Annex 7)
...
Lbs = F + 22.0*log10(fMHz) + 17.5*log10(theta.^2 + 4) + 17.0*log10(dt) + Lc - Yp;    % (E.4)
